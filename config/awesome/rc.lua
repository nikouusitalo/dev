...
-- Funktio joka avaa Rofin, kysyy hakusanan ja avaa Vivaldin tagissa 9
...
globalkeys = gears.table.join(
	...
	end, { description = "Open scratchpad terminal", group = "term" }),
...
tag.connect_signal("property::selected", function(t)
	local url = tag_urls[t.index]
	if url and t.selected then
		local found = false
